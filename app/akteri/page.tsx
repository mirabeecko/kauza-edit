export default function AkteriPage() {
  const actors = [
    ...
    },
    {
      ...
      category: 'Vyloučení členové',
      status: 'negative',
      summary: 'Spolupracovník Vaniše. Spolupodílel se na všech činech Vaniše.',
      keyActions: [
        'Spolupráce s Vanišem na porušování povinností',
        'Spoluúčast na nevybírání/neodvádění příspěvků',
    ...
    },
    {
      ...
      status: 'negative',
      summary: 'Nedodal seznamy členů. Přiznal hotovost 26.674 Kč v pokladně, kterou nepředal.',
      keyActions: [
        'Nedodal seznamy členů',
        'Neuhradil členské příspěvky',
        'Přiznal 26.674 Kč, které nepředal',
    ...
    },
    {
      ...
      category: 'Zánik členství',
      status: 'negative',
      summary: 'Nikdy nebyl předsedou oddílu karate (dle zápisu byl předsedou Jiří Kulík).',
      keyActions: [
        'Nedodal seznamy členů',
        'Neuhradil členské příspěvky',
        'Zánik členství neplacením příspěvků',
